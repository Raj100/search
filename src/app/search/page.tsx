...
const SearchPage: React.FC = () => {
  ...
  const weatherData = results?.locality_weather_data || {};
        ...
        <div className="w-full max-w-4xl space-y-6">
           {!loading && weatherData ? (
            <div className="bg-white p-4 rounded-lg shadow-md dark:bg-gray-800">
              ...
              <p><strong>Rain Intensity:</strong> {weatherData.rain_intensity} mm/h</p>
              <p><strong>Rain Accumulation:</strong> {weatherData.rain_accumulation} mm</p>
            </div>
          ) : (
